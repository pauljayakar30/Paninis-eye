...
An **Intelligent Generative AI Solution** for reconstructing damaged Sanskrit manuscripts using advanced transformer models, Google Gemini AI, multi-modal understanding, and Paninian grammar constraints.## 🚀 **SYSTEM IS NOW FULLY OPERATIONAL**



## 🎯 Project Overview✅ **Frontend**: http://localhost:3000 (React App with Material-UI)  

✅ **Backend API**: http://localhost:8000 (FastAPI with comprehensive endpoints)  

This system combines cutting-edge AI technology with traditional Sanskrit scholarship to help preserve ancient manuscripts. Built within hackathon constraints, it demonstrates core capabilities with room for expansion.✅ **API Documentation**: http://localhost:8000/docs  

✅ **Gemini Restoration**: http://localhost:3000/gemini-restoration (Google Gemini AI)
...
- **FastAPI Backend**: RESTful API with WebSocket support for real-time updates- ✅ **Image Upload & OCR Processing**

- **Google Gemini AI Integration**: Advanced text restoration and translation- ✅ **Damage Detection & Masking** 

- **Multilingual Support**: Sanskrit, Hindi, Telugu, Tamil, and English translations- ✅ **AI-Powered Text Reconstruction**

- ✅ **Sanskrit to English Translation** (Literal & Idiomatic)

### ✅ Key Capabilities- ✅ **Interactive AI Assistant**

1. **Manuscript Processing**- ✅ **Real-time WebSocket Communication**

   - Image upload and OCR text extraction- ✅ **Uncertainty Quantification**

   - Damage detection using computer vision- ✅ **Grammar Rule Integration**

   - AI-powered text reconstruction- ✅ **🆕 Google Gemini AI Restoration** (Advanced AI-powered restoration)

- ✅ **🆕 Text-to-Speech Integration** (Sanskrit pronunciation & English narration)
...
2. **Sanskrit Translation** 
   ...
   - Cultural context and source identification**� Enhannced Sanskrit Restoration** - Expert linguist-level manuscript restoration:

- **🔬 Expert AI System**: Indian linguist, epigraphist & paleographer specialization
...
3. **AI Assistant**- **📚 Pāṇinian Grammar**: Aṣṭādhyāyī rule application and citations
   ...
   - Manuscript analysis guidance- **📊 Confidence Scoring**: Reliability metrics for each restoration

- **🏛️ Cultural Context**: Textual source and tradition identification
...
## 🚀 Quick Start- Choose translation style:
...
```bash### 6. **🆕 Use Gemini AI Restoration**
...
# Create virtual environment## 🧠 Intelligent AI Features
...
```bashFrontend (React/Streamlit) → API Gateway (FastAPI) → Intelligent Services:

cd src/frontend/react-app├── OCR Service (Multi-Engine + CV Damage Detection)

npm install├── Intelligent Sanskrit Generator (MT5-Large + KG Integration)

```│   ├── Multi-Modal Fusion (Text + Image Context)

│   ├── Uncertainty Quantification (Epistemic + Aleatoric)

### Running the Application│   ├── Meta-Learning Adapter (Few-Shot Learning)

│   ├── Episodic Memory Bank (Case-Based Reasoning)

1. **Start Backend** (Terminal 1)│   └── Contextual Attention (Multi-Scale Understanding)

```bash├── Knowledge Graph Engine (Neo4j + Graph Neural Networks)

python backend_server.py├── Intelligent Constraint Engine (Learned Grammar Rules)
...
2. **Start Frontend** (Terminal 2)## 🚀 **ONE-COMMAND START** 
...
- Gemini Restoration: http://localhost:3000/gemini-restoration- ✅ Install missing dependencies automatically

- API Documentation: http://localhost:8000/docs- ✅ Set up directories and sample data

- ✅ Start backend API server (port 8000)

## 📁 Project Structure- ✅ Start React frontend (port 3000)
...
├── backend_server.py          # Main FastAPI server### Alternative Options

├── run.py                     # System launcher

├── src/```bash

│   ├── api/                   # API endpoints# Interactive setup with choices

│   ├── models/                # ML models (MT5, transformers)python run.py

│   ├── ocr/                   # OCR service

│   ├── kg/                    # Knowledge graph# Just run tests

│   └── frontend/python test_system.py

│       └── react-app/         # React application

│           ├── src/# Docker deployment

│           │   ├── components/  # Reusable componentsdocker-compose up -d

│           │   ├── pages/       # Main pages

│           │   └── services/    # API clients# Access the system
...
## 📚 Technology Stack- `POST /upload` - Upload manuscript image
...
### Frontend### 🤖 **Advanced AI Capabilities**
...
### Planned/Partial### 📚 **Sanskrit Expertise**
...
## 📖 Usage Example- **Interactive Visualization**: Real-time KG exploration and rule explanation
...
## 🤝 Contributing### Reconstruct Damaged Text
...
## 📄 License### Translate Sanskrit Text
...
## ⚠️ Disclaimercurl -X POST "http://localhost:8000/assistant/query" \
